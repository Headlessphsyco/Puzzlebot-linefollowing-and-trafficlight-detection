...
def live_sign_detection():
    ...
    MODEL_NAME = "/home/puzzlebot/catkin_ws/src/object_detection/custom_model_lite"
    ...
    # launching node
    rospy.init_node('detect_objects_webcam', anonymous=False)
